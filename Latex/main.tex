...
\begin{figure}[H]
    ...
    \caption{Boundary condition verification.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Latex/MATLABfigures/13_1.png} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Latex/MATLABfigures/13_2.png} 
    \caption{Centerline and velocity-weighted mean temperature.}
    \label{cent_mean_temp}
\end{figure}

\textbf{14. Temperature plots.} 
